...
const OnlineStatus: React.FC = () => {
  ...
  if (!isOnline) {
    return (
      <div
        className="fixed top-4 right-4 z-50 px-4 py-2 rounded-lg shadow-lg bg-amber-600 text-white transition-all duration-300"
      >
        <div className="flex items-center gap-2">
          ...
          <span className="font-medium">אין חיבור לרשת, הלוח עובד מהעותק המקומי</span>
        </div>
      </div>
    );
  }
